...
let codigo =
document.getElementById("filtroCodigo").value.toLowerCase();
...
let unidade =
document.getElementById("filtroUnidade").value.toLowerCase();


let ncm =
document.getElementById("filtroNcm").value.toLowerCase();




let lista =
sped.produtos.filter(p=>
...
p.descricao.toLowerCase().includes(descricao)

&&

p.unidade.toLowerCase().includes(unidade)

&&

p.ncm.toLowerCase().includes(ncm)
